...
import com.google.gson.GsonBuilder;
            ...
            public class LoginRsp implements MessageInterface 
            {
               ...
               public LoginRsp(String pJsonString ) {
                    
                    JsonDecoder tDecoder = new JsonDecoder( pJsonString );
                    this.decode( tDecoder );
               }
    
            public LoginRsp setRqstId( Integer pRqstId ) {
            mRqstId = pRqstId;
            return this;
            }
            ...
            public LoginRsp setSuccess( Boolean pSuccess ) {
            mSuccess = pSuccess;
            return this;
            }
        ...
        public void encode( JsonEncoder pEncoder) {
            ...
            JsonEncoder tEncoder = new JsonEncoder();
            pEncoder.add("LoginRsp", tEncoder.toJson() );
        ...
        public void decode( JsonDecoder pDecoder) {
            ...
            JsonDecoder tDecoder = pDecoder.get("LoginRsp");
        ...
        public static  Builder getLoginRspBuilder() {
            return new LoginRsp.Builder();
        }


        public static class  Builder {
          private LoginRsp mInstance;

          private Builder () {
            mInstance = new LoginRsp();
          }
